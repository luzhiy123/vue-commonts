    ...
    >
        <template v-if="type !== 'textarea'">
            ...
            <input
                ...
                @blur="handleBlur"
                @change="handleChange"
                @keydown.enter.capture="handleInputEnter"
            >
            <!-- 前置内容 -->
            <span
...
export default {
    ...
    methods: {
        handleInputEnter(e) {
            this.isComposing || this.$emit("intput-enter", e);
        },
        focus() {
            this.getInput().focus();
        },
        ...
        handleCompositionStart() {
            this.isComposing = this.inputRef.composing = true;
        },
        ...
        handleCompositionEnd(event) {
            if (this.isComposing) {
                this.isComposing = this.inputRef.composing = false;
